...
public class HyperedgeRenderer<V,E> implements Renderer.Edge<V,E> {
  ...
  private Predicate<Context<Hypergraph<V,E>,E>> drawAsHyperedge = TruePredicate.getInstance();
	 ...
	 * @param hg 
	 */
	protected void drawHyperedge(RenderContext<V,E> rc, Layout<V,E> layout, E e, Hypergraph<V, E> hg) {		
		

		EdgeLayout<E> edgeLocations = BasicHypergraphRenderer.getEdgeLayout(layout);
    ...
    if (draw_paint != null)
    {
		...
		Point2D edgeLoc = edgeLocations.getEdgeLocation(e);
