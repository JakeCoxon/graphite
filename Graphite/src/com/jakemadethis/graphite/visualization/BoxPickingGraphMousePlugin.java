 ...
 * @author Tom Nelson
 */
public class BoxPickingGraphMousePlugin<V, E> extends AbstractGraphMousePlugin
	 ...
	 */
	public BoxPickingGraphMousePlugin() {
	 ...
	 */
    public BoxPickingGraphMousePlugin(int selectionModifiers, int addToSelectionModifiers) {
